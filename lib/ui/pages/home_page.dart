...
import 'package:task_management_app/ui/pages/add_task_page.dart';
import 'package:task_management_app/ui/size_config.dart';
import 'package:task_management_app/ui/theme.dart';
import 'package:task_management_app/ui/widgets/button.dart';
import 'package:task_management_app/ui/widgets/task_tile.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  showBottomSheet(BuildContext context, Map<String, dynamic> task) {
    Get.bottomSheet(
      Container(
        ...
        child: Column(children: [
          ...
          task['isCompleted'] == 1
              ...
              : _buildBottomSheetButton(
                  ...
                  onTap: () {
                    _taskController.markTaskCompleted(task['_id']);
                    Get.back();
                  },
                  clr: primaryClr),
          _buildBottomSheetButton(
              label: "Delete Task",
              onTap: () {
                _taskController.deleteTask(task['_id']);
                Get.back();
              },
              clr: Colors.red[300]!),
          SizedBox(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: isClose ?? false ? Colors.transparent : clr,
        ),
        child: Center(
          child: Text(
            label,
